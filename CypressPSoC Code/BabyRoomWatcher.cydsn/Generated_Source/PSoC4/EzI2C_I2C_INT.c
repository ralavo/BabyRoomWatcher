...
CY_ISR(EzI2C_I2C_ISR)
{
    ...
    */
    ...
    {
        EzI2C_CTRL_REG &= (uint32) ~EzI2C_CTRL_ENABLED; /* Disable scb IP */

        EzI2C_state = EzI2C_I2C_FSM_IDLE;

        EzI2C_DISABLE_SLAVE_AUTO_DATA;
        EzI2C_DISABLE_MASTER_AUTO_DATA;
        ...
        EzI2C_ClearTxInterruptSource(EzI2C_INTR_RX_ALL);
        EzI2C_ClearRxInterruptSource(EzI2C_INTR_TX_ALL);
        EzI2C_ClearSlaveInterruptSource(EzI2C_INTR_SLAVE_ALL);
        EzI2C_ClearMasterInterruptSource(EzI2C_INTR_MASTER_ALL);
    #endif /* (EzI2C_CY_SCBIP_V0) */

        EzI2C_CTRL_REG |= (uint32) EzI2C_CTRL_ENABLED;  /* Enable scb IP */
    }
